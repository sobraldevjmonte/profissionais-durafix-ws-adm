...
//---------- salvar anexos ---------
router.post(
    "/anexararquivos/:id_venda",
    uploadComprovantes.single("comprovante"),
    VendasController.salvarAnexosVendas
);
...
//--------selecionar cliente para a venda atual ---------
router.get(
    "/listarpedidosusuario/:id_usuario",
    VendasController.listarPedidoUsuario
);
